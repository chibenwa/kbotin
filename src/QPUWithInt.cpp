...
* \date 21/06/2013
*
* \brief Bouton permettant de déplier un contact (très légerement surchargé ) :p
* 
...
QPUWithInt::QPUWithInt(int n):QPushButton("-")
{
	this->setMaximumSize(this->sizeHint());
	N=n;
	connect(this, SIGNAL( clicked() ), this, SLOT( Delete() ) );
} 

void QPUWithInt::Delete()
{
	emit deleteMe(N);
}
