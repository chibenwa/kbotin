/*!
* \file doublonWidget.hpp
* \author Benoit Tellier
* \version 0.1
* \date 21/06/2013
*
* \brief Classe surchargeant l'affichage des doublons....
* 
...
#ifndef DOUBLONWIDGET__HPP__
#define DOUBLONWIDGET__HPP__
...
class DoublonWidget : public AllWidget
{
	public:
	DoublonWidget(std::vector<Kontact*>* plop, MainWindow* w, bool b = false);
	~DoublonWidget();
};
