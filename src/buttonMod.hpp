...
* \date 21/06/2013
*
* \brief Classe définissant un bouton destiné à la suppression de contacts, ains qu'à leur visionnement.
* 
...
#ifndef BUTTONMOD__HPP__
#define BUTTONMOD__HPP__
...
class ButtonMod: public QPushButton
{
	Q_OBJECT
	public:
		ButtonMod(QString, Group*, bool b);
	public slots:
		void del();
		void show();
	signals:
