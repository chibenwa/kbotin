...
#ifndef DISTANTWIDGET__HPP__
#define DISTANTWIDGET__HPP__
...
class DistantWidget: public QWidget
{
		Q_OBJECT
	public:
		DistantWidget(std::vector<Kontact*>*, QString, MainWindow*);
		~DistantWidget();
	public slots:
		void print();
		void sendAll();
