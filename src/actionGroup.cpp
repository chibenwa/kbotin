...
* \date 21/06/2013
*
* \brief action réimplémenté pour plus de simplicité.
* 
...
ActionGroup::ActionGroup(QString title, MainWindow* w, Group* g):QAction(title, w)
{
	mW = w;
	mGroup = g;
	connect( this, SIGNAL( triggered() ), this, SLOT( act() ) );
}

void ActionGroup::act()
{
	mW->showGroup(mGroup);
}
