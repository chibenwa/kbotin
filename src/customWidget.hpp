...
* \date 21/06/2013
*
* \brief Classe affichant une fenêtre montrant les noms prénoms du contact. Si on la déplie, on peu consulter le contact intégralement.
* 
...
#ifndef CUSTOMWIDGET__HPP__
#define CUSTOMWIDGET__HPP__
...
class CustomWidget : public QWidget
{
	Q_OBJECT
	public:
		CustomWidget(Kontact*, MainWindow*, AllWidget*, bool isG = false, bool dist = false);
	public slots:
		void showContact();
		void removeKontactFromGroup();
	signals:
		void please(int);
	protected:
	bool mIsG;
	...
	QPushButton* mDeplie;
	QLabel* contactOverview;
	QLabel* imageLabel;
	KontactWidget* details;
	QPushButton* mDeleteFromGroup;
};
