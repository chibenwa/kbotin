...
class Cvs
{
	public:
		Cvs();
		static void imports(QString fileName, TypeCvs, std::vector<Kontact*>* dest, MainWindow*);
		static void importsFromTemplate(QString filePath, QString templatePath, std::vector<Kontact*>* dest, MainWindow*);
		static bool exportsFromTemplate(QString filePath, QString templatePath, std::vector<Kontact*>* orig, MainWindow*);
};
